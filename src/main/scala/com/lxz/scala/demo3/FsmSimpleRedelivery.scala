...
/**
  ...
  * </pre>
  *
  * ... will result in the second requester getting a [[SimpleOrderedRedeliverer]] message with [[UUID]]s
  * of both his request and currently-processed one.
  *
  * @param retryTimeout how long to wait for the [[SimpleOrderedRedeliverer]] message
  */
